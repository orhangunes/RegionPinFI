...
KNOB<string> fi_activation_file (KNOB_MODE_WRITEONCE, "pintool", "fi_activation", "activate", "specify fault injection activation file");
...
class RegMap{
	...
	private:
    	void createMap() {
			...
			/*ORHAN COMMENT - adding REG_MXCSR*/
			reg_map[132] = new Reg_Info(REG_MXCSR, REG_MXCSR, 0, 32, true);
...
/*ORHAN COMMENT - Getting dynamic instcount file name function*/
